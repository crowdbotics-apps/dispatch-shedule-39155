...
## Project Structure
    ...
    ├── dispatch_shedule_39155  # Django project configurations
...
1. Clone this repo and `cd dispatch_shedule_39155`
...
2. Clone this repo and `cd dispatch_shedule_39155`
